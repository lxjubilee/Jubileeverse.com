    ...
    <div className="nav-bar">
      <div className="nav-bar-inner">
        ...
        <div className="nav-right">
          {/* Named explicitly because the label is hidden on narrower viewports
              (see the nav-fit block in globals.css) and the button is then just
              the gear — title alone is not reliably announced. */}
          <button
